          ...
          <div className={styles.controls}>
            <div className={styles.controls_left}>
              <div className={styles.control_group}>
                ...
                <input
                  ...
                  type="number" id="spring-deformation"
                  onChange={handleInputChange} />
              </div>
              <div className={styles.control_group}>
                <label className={styles.control_label} htmlFor="speed">Направленная скорость (v0, м/с)</label>
                <input className={styles.control_input} type="number" id="speed" onChange={handleInputChange} />
              </div>
              <div className={styles.control_group}>
                <label className={styles.control_label} htmlFor="time">Время, с</label>
                <input className={styles.control_input} type="number" id="time" onChange={handleInputChange} />
              </div>
            </div>
            <div className={styles.controls_right}>
              <div className={styles.control_group}>
                ...
                <input className={styles.control_input} type="number" id="spring-stiffness" onChange={handleInputChange} />
              </div>
              <div className={styles.control_group}>
                <label className={styles.control_label} htmlFor="medium-viscosity">Вязкость среды (μ)</label>
                <input className={styles.control_input} type="number" id="medium-viscosity" onChange={handleInputChange} />
              </div>
              <div className={styles.control_group}>
                <label className={styles.control_label} htmlFor="object-mass">Масса объекта (M, т)</label>
                <input className={styles.control_input} type="number" id="object-mass" onChange={handleInputChange} />
              </div>
            </div>
          </div>
        </div>
